...
interface MailClientOTPProps {
  userName?: string | null;
  code: string;
}

export default function MailClientOTP({
  userName,
  code
}: MailClientOTPProps) {
  return (
        ...
        <Container style={{ 
          ...
          <Section style={{ paddingTop: "40px", paddingBottom: "40px", paddingLeft: "24px", paddingRight: "24px" }}>
            ...
            <Text style={{ 
              ...
              Vous avez demandé un code de connexion pour accéder à votre espace client.
            </Text>
          ...
          <Section style={{ 
            ...
            <Text style={{ 
              ...
              <strong>BailNotarie</strong> - Espace Client
            </Text>
            <Text style={{ 
              color: "#6b7280",
              fontSize: "12px",
