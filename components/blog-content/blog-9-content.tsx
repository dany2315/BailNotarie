      ...
      <section aria-labelledby="temporaires" className="my-12">
        ...
        <div className="space-y-6">
          ...
          <div className="bg-orange-50 rounded-lg border border-orange-200 p-6">
            <div className="flex items-start mb-4">
              <Zap className="h-6 w-6 text-orange-600 mr-3 shrink-0 mt-0.5" aria-hidden="true" />
              <div>
            ...
            <div className="space-y-3 text-sm">
              ...
              <div className="bg-red-50 rounded p-4 border border-red-200">
                <div className="flex items-start">
                  <AlertTriangle className="h-5 w-5 text-red-600 mr-2 mt-0.5 shrink-0" aria-hidden="true" />
                  <div>
